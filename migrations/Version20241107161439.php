 ...
 */
final class Version20241107161439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gridfile (id INT AUTO_INCREMENT NOT NULL, original_name VARCHAR(255) NOT NULL, stored_name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, width INT DEFAULT NULL, height INT DEFAULT NULL, filesize INT NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_STOREDNAME (stored_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gridfile_gridtable (gridfile_id INT NOT NULL, gridtable_id INT NOT NULL, INDEX IDX_2F8464AA4A12585E (gridfile_id), INDEX IDX_2F8464AA24F1A0FD (gridtable_id), PRIMARY KEY(gridfile_id, gridtable_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE gridsetting (id INT AUTO_INCREMENT NOT NULL, scope_id INT NOT NULL, gridcol_id INT NOT NULL, setting_key VARCHAR(30) NOT NULL, parameter VARCHAR(255) DEFAULT NULL, INDEX IDX_46AD99AA682B5931 (scope_id), INDEX IDX_46AD99AAC34B86BB (gridcol_id), UNIQUE INDEX UNIQ_IDENTIFIER_SCOPECOLTYPE (scope_id, gridcol_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gridfile_gridtable ADD CONSTRAINT FK_2F8464AA4A12585E FOREIGN KEY (gridfile_id) REFERENCES gridfile (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE gridfile_gridtable ADD CONSTRAINT FK_2F8464AA24F1A0FD FOREIGN KEY (gridtable_id) REFERENCES gridtable (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gridfile_gridtable DROP FOREIGN KEY FK_2F8464AA4A12585E');
        $this->addSql('ALTER TABLE gridfile_gridtable DROP FOREIGN KEY FK_2F8464AA24F1A0FD');
        ...
        $this->addSql('DROP TABLE gridfile_gridtable');
