 ...
 */
final class Version20241030160550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gridpool (id INT AUTO_INCREMENT NOT NULL, scope_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_9674E4C682B5931 (scope_id), UNIQUE INDEX UNIQ_IDENTIFIER_NAMESCOPE (name, scope_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gridrow (id INT AUTO_INCREMENT NOT NULL, pool_id INT NOT NULL, masterkey VARCHAR(255) DEFAULT NULL, INDEX IDX_CE805B7E7B3406DF (pool_id), UNIQUE INDEX UNIQ_IDENTIFIER_MASTERKEY (masterkey), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
